        ...
        window.saveContractText = async function () {
            ...
            try {
                const token = await auth.currentUser.getIdToken();
                const resp = await fetch('/api/account?action=updateContractText', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
                    ...
                    try {
                        ...
                        if (orderSnap.exists()) {
                            ...
                            if (orderData.customerEmail) {
                                await fetch('/api/account?action=sendDeliveryEmail', {
                                    method: 'POST',
                                    headers: {
                                        'Content-Type': 'application/json',
                                        'Authorization': `Bearer ${token}`
        ...
        window.loadHappyCodeRequests = async function () {
            ...
            try {
                const token = await auth.currentUser.getIdToken();
                const resp = await fetch('/api/account?action=listHappyCodeRequests', {
                    method: 'POST',
        ...
        window.approveHappyCodeRequest = async function (requestId) {
            ...
            try {
                const token = await auth.currentUser.getIdToken();
                const resp = await fetch('/api/account?action=approveHappyCodeChange', {
                    method: 'POST',
        ...
        window.rejectHappyCodeRequest = async function (requestId) {
            ...
            try {
                const token = await auth.currentUser.getIdToken();
                const resp = await fetch('/api/account?action=rejectHappyCodeChange', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}` },
        ...
        window.handleRecipientFilterChange = async function (filter) {
            ...
            if (filter === 'custom') {
                ...
                try {
                    const token = await auth.currentUser.getIdToken();
                    const resp = await fetch(`/api/account?action=getRecipients&filter=${filter}`, {
                        method: 'POST',
                        headers: { 'Authorization': `Bearer ${token}` }
                    });
                    const data = await parseJsonResponse(resp);
        ...
        async function loadUsersForSelection() {
            ...
            try {
                const token = await auth.currentUser.getIdToken();
                const resp = await fetch('/api/account?action=getUsersList', {
                    method: 'POST',
                    headers: { 'Authorization': `Bearer ${token}` }
                });
                const data = await parseJsonResponse(resp);
        ...
        window.sendMarketingCampaign = async function () {
            ...
            try {
                const token = await auth.currentUser.getIdToken();
                const res = await fetch('/api/account?action=sendBulk', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
        ...
        window.updateTopProducts = async function () {
            ...
            try {
                const token = await auth.currentUser.getIdToken();
                const res = await fetch('/api/getConfig?action=updateTopProducts', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${token}`
